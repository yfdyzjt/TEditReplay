...
public class ReplayFrame
{
    ...
    public static IEnumerable<UndoTile> ReadTiles(BinaryReader reader)
    {
        return UndoBuffer.ReadUndoTilesFromStream(reader, WorldConfiguration.SettingsTileFrameImportant);
    }
}
